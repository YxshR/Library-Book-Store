  ...
  return (
    ...
    <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
       ...
       <h1 className="text-4xl font-bold">Hello, Welcome here to learn something {" "} <span className="text-pink-500">new everyday!!! </span></h1>
        <p className="text-xl   ">
        Creating a comprehensive online library management system using the MERN stack (MongoDB, Express.js, React.js, Node.js) involves several steps. Below is a high-level guide to building such a system:
        </p>
